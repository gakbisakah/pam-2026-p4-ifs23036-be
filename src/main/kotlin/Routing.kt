...
fun Application.configureRouting() {
    ...
    routing {
        ...
        route("/movies") {
            get { movieService.getAllMovies(call) }
            post { movieService.createMovie(call) }
            get("/{id}") { movieService.getMovieById(call) }
            put("/{id}") { movieService.updateMovie(call) }
            delete("/{id}") { movieService.deleteMovie(call) }
            get("/{id}/image") { movieService.getMovieImage(call) }
        }
